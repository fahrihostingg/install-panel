...
![Test Panel](https://github.com/fahrihostingg/install-panel/actions/workflows/panel.yml/badge.svg)
![Test Wings](https://github.com/fahrihostingg/install-panel/actions/workflows/wings.yml/badge.svg)
![Shellcheck](https://github.com/fahrihostingg/install-panel/actions/workflows/shellcheck.yml/badge.svg)
...
```bash
bash <(curl -s https://raw.githubusercontent.com/fahrihostingg/install-panel/main/install.sh)
```
